...
const DropDownMenuButton =(props)=> {
    ...
    const generateBtnImage = ()=>{
        if(props.imgWidth && props.imgHeight){
           return <img style={{width: props.imgWidth, height: props.imgHeight}} src={props.btn_Pic_Src}></img>
        }
        else{
           return <img className={MenuBtnCss.BtnImg} src={props.btn_Pic_Src}></img>
        }
    }
