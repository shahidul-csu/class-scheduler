...
const AddCoursePg = () => {
    ...
    const AddCourse = () => {
        if (userData.is_superuser) {
            axios(getCourseModelConfig("POST", "", {
                name: courseName, capacity: +classSize, units: +units, number_per_week: +weeklyFrequency,
                section: courseSection, course_group: courseGroup, sync_time: syncTime
