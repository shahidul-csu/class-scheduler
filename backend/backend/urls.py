...
urlpatterns = [
    ...
    path('api/', include([
        ...
        path('get_preference_for_semester/<int:semesterId>/<int:userId>/', getPreferenceEntriesPerSemester,
        ...
        path('get_parameter_data/<int:parameterId>/',
             getParameterData, name='get_parameter_data'),
        path('get_user_preference_option_entries/<int:semesterId>/<int:userId>/', getUserPreferenceOptionEntries,
             name='get_user_preference_option_entries'),
        path('get_preference_parameter_ids/<int:semesterId>/<int:userId>/', getPreferenceParameterIds,
